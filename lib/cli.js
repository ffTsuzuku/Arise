...
function showUsage() {
  console.log(`
Herdr Worktree Manager - Unified Worktree & Workspace Orchestrator

Usage:
  herdr-worktree --branch <branch> [options]
  herdr-worktree --nuke [<worktree dir or branch>] [nuke-options]
  herdr-worktree --cleanup [<worktree dir or branch>] [nuke-options]
